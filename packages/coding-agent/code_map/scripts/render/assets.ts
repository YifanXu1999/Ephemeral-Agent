...
/* ── Configuration tab ── */
.subnav{display:flex;gap:2px;margin:0 0 18px;border-bottom:1px solid var(--line)}
.subnav-i{padding:8px 14px;color:var(--dim);font-weight:550;font-size:13px;border-bottom:2px solid transparent;margin-bottom:-1px}
.subnav-i:hover{color:var(--ink);text-decoration:none}
.subnav-i.on{color:var(--accent);border-bottom-color:var(--accent)}
.meta{color:var(--faint);font-size:12.5px;margin:-2px 0 16px}
.cfg-card{background:var(--surface);border:1px solid var(--line);border-radius:12px;padding:15px 18px;margin:0 0 14px;scroll-margin-top:96px}
.cfg-card>h3{margin:0 0 4px;font-size:16px}
.cfg-kv{display:grid;grid-template-columns:128px 1fr;gap:5px 14px;margin:10px 0 0;font-size:13px}
.cfg-kv dt{color:var(--faint);font-size:11px;text-transform:uppercase;letter-spacing:.04em;padding-top:3px}
.cfg-kv dd{margin:0}
.cfg-kv dd.tags{display:flex;flex-wrap:wrap;gap:5px}
.tag{display:inline-block;background:var(--line2);border:1px solid var(--line);border-radius:6px;padding:1px 8px;font-size:12px;color:var(--ink);margin:0 2px 2px 0}
.tag:hover{border-color:var(--accent);text-decoration:none}
.tag.tool{font-family:var(--mono);font-size:11.5px;background:#eef6ff;border-color:#dbe6ff;color:#2456c8}
.tag.tool.miss{background:#fdecec;border-color:#f6d5d5;color:#b13b3b;text-decoration:line-through}
.cfg-card details{margin-top:10px}
.cfg-card summary{cursor:pointer;color:var(--accent);font-size:12.5px}
.cfg-args{border-collapse:collapse;width:100%;font-size:12.5px;margin:10px 0 0}
.cfg-args td,.cfg-args th{border-bottom:1px solid var(--line2);padding:4px 8px;text-align:left}
.cfg-args th{color:var(--faint);font-size:11px;text-transform:uppercase}
.cfg-summary{border-color:#dbe6ff}
.gcols{display:grid;grid-template-columns:repeat(auto-fill,minmax(290px,1fr));gap:12px;margin-bottom:8px}
.gnode{background:var(--surface);border:1px solid var(--line);border-radius:10px;padding:11px 13px;scroll-margin-top:96px}
.gn-h{display:inline-block;font-weight:600;font-size:14px;color:var(--ink);margin-bottom:6px}
.edge{display:flex;gap:8px;align-items:baseline;font-size:12.5px;padding:2px 0;flex-wrap:wrap}
.ek{min-width:62px;color:var(--faint);font-size:11px;text-transform:uppercase;letter-spacing:.03em}
@media(max-width:900px){.cols{grid-template-columns:1fr}.ide{grid-template-columns:200px 1fr}.rail{display:none}.cfg-kv{grid-template-columns:1fr}}
`;
